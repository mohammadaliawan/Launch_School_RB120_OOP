class RpsGame
  ...
  def display_final_winner
    puts "#{human.name} Wins the Game!" if human.score == Player::WINNING_SCORE
    puts "#{computer.name} Wins the Game" if computer.score == Player::WINNING_SCORE
  end
  ...
  def play
    ...
    loop do
      while human.score < Player::WINNING_SCORE && computer.score < Player::WINNING_SCORE
        human.choose
        computer.choose
        display_moves
        display_winner
